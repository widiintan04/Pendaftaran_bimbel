                            ...
                            'daftar/insert'
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        ...
                                        <input type='tel' name='no_telp' placeholder='' class='form-control' required>
                                    </div>
                                    <div class='col-md-6'>
                                    ...
                                    <div class='col-md-6'>
                                        ...
                                        <textarea class='form-control' name='asal_sekolah' rows='4' placeholder='' required></textarea>
                                     </div>
                                     <div class='col-md-6'>
                                    ...
                                    <div class='col-md-12'>
                                        <div class='form-group'>
                                           <br><br> <button type="submit" name='save' class='btn btn-default'> Daftar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
